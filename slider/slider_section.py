...
class MySliders(QMainWindow):
    def __init__(self):
        ...
        self.cutoff0_slider_onset = SingleSlider("HighPass", 0, 1, 500, default=60, font_color="#AFAFAF")
        self.cutoff1_slider_onset = SingleSlider("LowPass", 8000, 1, 20000, default=10800, font_color="#AFAFAF")
        ...
        self.ref_len_slider_onset = SingleSlider("RefLen", 0, 1, 2000, default=1000, font_color="#AFAFAF")
        self.eps_ratio_slider_onset = SingleSlider("EPS%", 0, 1, 50, scale=0.001, default=20, font_color="#AFAFAF")

        self.amp_slider_offset = SingleSlider("", 100, 1, 300, scale=0.01, color="#2AD25E", default=194)
        self.cutoff0_slider_offset = SingleSlider("", 0, 1, 500, color="#2AD25E", default=200)
        ...
        self.ref_len_slider_offset = SingleSlider("", 0, 1, 2000, color="#2AD25E", default=1000)
        self.eps_ratio_slider_offset = SingleSlider("", 0, 1, 50, scale=0.001, color="#2AD25E", default=15)
