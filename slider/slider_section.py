...
class MySliders(QMainWindow):
    def __init__(self):
        ...
        self.cutoff0_slider_onset = SingleSlider("HighPass", 0, 1, 500, default=60)
        self.cutoff1_slider_onset = SingleSlider("LowPass", 8000, 1, 20000, default=10800)
        ...
        self.ref_len_slider_onset = SingleSlider("RefLen", 0, 1, 2000, default=1000)
        self.eps_ratio_slider_onset = SingleSlider("EPS%", 0, 1, 50, scale=0.001, default=20)
