...
class MySliders(QMainWindow):
    def __init__(self):
        ...
        self.ref_len_slider_onset = SingleSlider("RefLen", 0, 1, 2000, default=1000, font_color="#7F7F7F")
        self.eps_ratio_slider_onset = SingleSlider("EPS%", 0, 1, 50, scale=0.001, default=20, font_color="#7F7F7F")
